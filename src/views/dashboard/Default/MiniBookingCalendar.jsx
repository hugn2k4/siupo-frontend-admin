...
export default function MiniBookingCalendar({ isLoading: propIsLoading }) {
  ...
  // Get all dates for the calendar grid - ALWAYS 4 weeks (28 days)
  const calendarDays = useMemo(() => {
    const monthStart = startOfMonth(currentMonth);
    // Always start from Monday of the week containing the 1st of the month
    const calendarStart = startOfWeek(monthStart, { weekStartsOn: 1 }); // Monday

    // Always show exactly 4 weeks (28 days)
    const days = [];
    for (let i = 0; i < 28; i++) {
  ...
  // Group days into weeks (4 weeks × 7 days)
